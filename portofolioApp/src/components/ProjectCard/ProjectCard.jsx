...
function ProjectCard() {
  ...
  return (
    <>
      <div className="flex flex-col gap-80 p-4">
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-8">
            <motion.div
              ...
              variants={leftSlide}
              viewport={{ once: true }}
              className="min-h-96 w-full max-w-4xl rounded-xl shadow-2xl self-start"
            >
              <img src={notesApp} alt="" className="rounded-xl" />
              <motion.span
                whileHover={{
                  cursor: "pointer",
                  opacity: 1,
            ...
            >
              ...
              <div className="flex gap-4 bg-cyan-600 p-4 rounded-lg">
                <motion.img
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-8">
            ...
            >
              ...
              <div className="flex gap-4 bg-amber-500 p-4 rounded-lg">
                <motion.img
                  src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original-wordmark.svg"
                  alt=""
                  whileHover={{ scale: 1.2, cursor: "pointer" }}
            ...
            <motion.div
              ...
              className="min-h-96 w-full max-w-4xl rounded-xl shadow-2xl self-start"
            >
              <img src={inventory} alt="" className="rounded-xl" />
              <motion.span
                whileHover={{
                  cursor: "pointer",
                  opacity: 1,
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-8">
            <motion.div
              ...
              className="min-h-96 w-full max-w-4xl rounded-xl shadow-2xl self-start"
            >
              <img src={todolist} alt="" className="rounded-xl" />
              <motion.span
                whileHover={{
                  cursor: "pointer",
                  opacity: 1,
            ...
            >
              ...
              <div className="flex gap-4 bg-red-500 p-4 rounded-lg">
                <motion.img
